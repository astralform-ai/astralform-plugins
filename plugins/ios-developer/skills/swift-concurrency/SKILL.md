...
- `isolation.md` - Actors, MainActor, isolation domains, inheritance
- `sendable.md` - Sendable protocol, non-Sendable patterns, isolated parameters
- `common-mistakes.md` - Detailed examples of what to avoid

**Attribution**: This skill is adapted from [jamesrochabrun/skills](https://github.com/jamesrochabrun/skills/tree/main/skills/swift-concurrency).
